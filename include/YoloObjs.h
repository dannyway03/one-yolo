...
struct YoloSegObj
{
  ...
  cv::Mat mask;      // mask for detected object in segmentation task(it's a local & binary mask, has the same size as
                     // bounding box, has 2 values: 0 or 255)
  ...
  std::vector<cv::Point>
    track_points; // track points for detected object in segmentation task (empty means no tracked yet)
};
...
struct DrawParam
{
  ...
  float mask_alpha = 0.5f; // alpha of mask area, 0 means fully transparent, 1 means solid fill, and values in between
                           // represent semi-transparency
  ...
  KptPairColors kpt_pair_colors = {
    cv::Scalar(0, 0, 250),   cv::Scalar(0, 0, 250),   cv::Scalar(0, 0, 250),
    cv::Scalar(0, 0, 250),   cv::Scalar(0, 0, 250), // color of head part(BGR)
    cv::Scalar(220, 0, 250), cv::Scalar(220, 0, 250), cv::Scalar(220, 0, 250),
    cv::Scalar(220, 0, 250), cv::Scalar(220, 0, 250), cv::Scalar(220, 0, 250), // color of hand part(BGR)
    cv::Scalar(110, 250, 0), cv::Scalar(110, 250, 0), cv::Scalar(110, 250, 0), // color of body part(BGR)
    cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250),
    cv::Scalar(0, 255, 250), cv::Scalar(0, 255, 250)}; // color of leg part(BGR)
