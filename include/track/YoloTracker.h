...
private:
  ...
  void
  preprocess(const YoloResult& res, std::vector<cv::Rect>& boxes, std::vector<std::vector<float>>& embeddings);
  void
  run(const std::vector<cv::Rect>& boxes, const std::vector<std::vector<float>>& embeddings,
      std::vector<int>& track_ids);
  void
  postprocess(const std::vector<cv::Rect>& boxes, const std::vector<std::vector<float>>& embeddings,
