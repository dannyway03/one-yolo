...
YoloOVNRT::YoloOVNRT(const std::string& model_path, const std::string& device) : YoloRuntime("OpenVINO")
{
...
void
YoloOVNRT::submit(const cv::Mat& blob)
{
  if (!pipeline_ready_)
  {
...
auto
YoloOVNRT::collect() -> std::vector<cv::Mat>
{
